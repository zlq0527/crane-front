    ...
    <div class="user">
        ...
        <el-table
            ...
            <template slot-scope="scope">
                ...
                <el-button @click="handleDelete(scope.row.id)" type="text" size="small">删除用户</el-button>
            </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="添加用户" :visible.sync="addRoledialogFormVisible" width="30%">
            <el-form label-width="80px" size="small" :model="form" >
                    ...
                    <el-form-item label="真实姓名">
                        <el-input v-model="form.relName" placeholder="请输入真实姓名"></el-input>
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            handleDelete(id){
              const _this=this
              this.request.get("/deleteById/"+id).then(res=>{
                if(res){
